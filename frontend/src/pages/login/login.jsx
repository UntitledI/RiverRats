    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        <div className='h-full w-full bg-white-700 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-80 border border-gray-100'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Link to='/register' className='text-sm hover:underline hover:text-blue-600 mt-2 inline-block' href="#">Sign-up</Link>

                <div className="w-full flex items-center justify-center px-2 py-3 mb-1">
                    <button className="btn btn-block btn-xl mt-2 text-xl" disabled={loading}>
